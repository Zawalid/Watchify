  ...
  return (
    <div className={cn('flex flex-col gap-2', parentclassname)} ref={parent}>
      <div className='relative rounded-xl'>
        <textarea
          className={cn(
            'peer relative z-10 w-full rounded-xl border-2 border-Grey/800 bg-Black/10 px-4 pb-3 pt-7 text-sm text-Grey/100 outline-none placeholder:text-sm placeholder:text-transparent read-only:bg-transparent focus:border-Primary/500 focus:placeholder:text-Grey/600',
