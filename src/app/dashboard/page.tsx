...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col gap-12">
      <h2 className="text-3xl font-semibold text-Grey/50">
        Welcome <sub className="text-2xl text-Primary/300">Walid Zakan</sub>
      </h2>
...
function Stat({ count, name }: { count: number; name: string }) {
  return (
